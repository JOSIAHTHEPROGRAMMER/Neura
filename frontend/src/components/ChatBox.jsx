              ...
              {messages.length === 0 && (
                <div className='h-full  flex flex-col items-center justify-center 
                  ...
                  <span className="flex items-center text-7xl font-bold">
                         <img src={assets.logo} alt="Logo" className="h-[1em] w-auto inline-block" />
                         <span>eural</span>
                      </span>
...
>
  ...
  >
    <option className="dark:bg-primary/20" value="text">Text</option>
    <option className="dark:bg-primary/20" value="image">Image</option>
  </select>
